'use strict';
/* App Module */
var carWorkshopApp = angular.module('carWorkshopApp', [
    'ui.router', 'infrastructure', 'layoutNav', 'layoutFooter', 'layoutWelcome',
    'ownerList', 'ownerDetails', 'ownerForm', 'carForm', 'visits', 'workshopList']);

carWorkshopApp.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', '$httpProvider', function(
